            ...
            if board[pos[0]][pos[1]] != '.':                                #only look and letters
                ...
                if pos[1] != 5:
                    ...
                    if size2 == letter:                                               #Checks for a size 2 vehicles
                        ...
                        size3 = self.check_right(board, pos)             #check if its a truck with the size of 3
    ...
    def bfs(self, i, board, sols):
        ...
        while queue:
            ...
            if current[2][4] == 'X' and current[2][5] == 'X':
                ...
                vehicle_dict = self.find_vehicles(current)
                ...
                for i in range(0, num_of_veh):
                    ...
                    if axis == 'h':
                        self.possible_moves_left(current, loc, size, letter, NullHandler, rec_depth, chain)
                        self.possible_moves_right(current, loc, size, letter, NullHandler, rec_depth, chain)
                    elif axis == 'v':
                        self.possible_moves_down(current, loc, size, letter, NullHandler, rec_depth, chain)
                        self.possible_moves_up(current, loc, size,letter, NullHandler, rec_depth, chain)
